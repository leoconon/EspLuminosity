...
void drawMoon() {
    ...
    u8g2_SetDrawColor(&u8g2, 1);
    // u8g2_DrawPixel(&u8g2, 104, 8);
    // u8g2_DrawPixel(&u8g2, 98, 15);
    // u8g2_DrawPixel(&u8g2, 92, 13);
    // u8g2_DrawPixel(&u8g2, 110, 15);
    // u8g2_DrawPixel(&u8g2, 66, 23);
    // u8g2_DrawPixel(&u8g2, 128, 38);
    // u8g2_DrawPixel(&u8g2, 11, 26);
    // u8g2_DrawPixel(&u8g2, 89, 15);
    // u8g2_DrawPixel(&u8g2, 123, 19);
    // u8g2_DrawPixel(&u8g2, 61, 23);
    // u8g2_DrawPixel(&u8g2, 50, 17);
    // u8g2_DrawPixel(&u8g2, 48, 6);
    // u8g2_DrawPixel(&u8g2, 57, 29);
    // u8g2_DrawPixel(&u8g2, 11, 9);
    // u8g2_DrawPixel(&u8g2, 80, 15);
    // u8g2_DrawPixel(&u8g2, 13, 7);
    // u8g2_DrawPixel(&u8g2, 81, 12);
    // u8g2_DrawPixel(&u8g2, 91, 41);
    // u8g2_DrawPixel(&u8g2, 105, 28);
    // u8g2_DrawPixel(&u8g2, 6, 20);
    u8g2_SetFont(&u8g2, u8g2_font_unifont_t_symbols);
    u8g2_DrawGlyph(&u8g2, 104, 8, 0x2605);
    u8g2_DrawGlyph(&u8g2, 98, 15, 0x2605);
    u8g2_DrawGlyph(&u8g2, 92, 13, 0x2605);
    u8g2_DrawGlyph(&u8g2, 110, 15, 0x2605);
    u8g2_DrawGlyph(&u8g2, 66, 23, 0x2605);
    u8g2_DrawGlyph(&u8g2, 128, 38, 0x2605);
    u8g2_DrawGlyph(&u8g2, 11, 26, 0x2605);
    u8g2_DrawGlyph(&u8g2, 89, 15, 0x2605);
    u8g2_DrawGlyph(&u8g2, 123, 19, 0x2605);
    u8g2_DrawGlyph(&u8g2, 61, 23, 0x2605);
    u8g2_DrawGlyph(&u8g2, 50, 17, 0x2605);
    u8g2_DrawGlyph(&u8g2, 48, 6, 0x2605);
    u8g2_DrawGlyph(&u8g2, 57, 29, 0x2605);
    u8g2_DrawGlyph(&u8g2, 11, 9, 0x2605);
    u8g2_DrawGlyph(&u8g2, 80, 15, 0x2605);
    u8g2_DrawGlyph(&u8g2, 13, 7, 0x2605);
    u8g2_DrawGlyph(&u8g2, 81, 12, 0x2605);
    u8g2_DrawGlyph(&u8g2, 91, 41, 0x2605);
    u8g2_DrawGlyph(&u8g2, 105, 28, 0x2605);
    u8g2_DrawGlyph(&u8g2, 6, 20, 0x2605);
    u8g2_SendBuffer(&u8g2);
}
